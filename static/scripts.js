// scripts.js
// ---------------------------
// Core JS for avatar selection, audio recording, and seamless video playback
// ---------------------------
document.addEventListener('DOMContentLoaded', () => {
    ...
    Object.assign(videoB.style, {
        position: 'absolute', top: '0', left: '0', width: '100%', height: '100%', objectFit: 'contain', transition: 'opacity 0.2s ease-in-out', opacity: 0, zIndex: 0
    });
    videoA.style.transition = 'opacity 0.2s ease-in-out';
    videoA.style.zIndex = 1;
    videoA.style.objectFit = 'contain';
    videoA.style.maxHeight = '400px';
